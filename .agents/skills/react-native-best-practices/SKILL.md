...
| `references/performance/SKILL.md` | React Native JavaScript performance, FPS, re-renders, FlatList/FlashList, React Compiler, atomic state, memory leaks (JS), concurrent React, animations performance |
| `references/bundle-size/SKILL.md` | JS bundle analysis, tree shaking, barrel exports, app size, R8/ProGuard, Hermes mmap, code splitting, asset catalogs |
| `references/native-profiling/SKILL.md` | Native profiling (Xcode/Android Studio), TTI measurement, native memory leaks, Turbo Modules, native threading model, View flattening, Android 16kb alignment |
